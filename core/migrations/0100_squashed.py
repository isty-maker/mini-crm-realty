    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("external_id", models.CharField(blank=True, max_length=100, unique=True, verbose_name="Внешний ID")),
                ("category", models.CharField(blank=True, choices=[("house", "Дом"), ("flat", "Квартира"), ("room", "Комната"), ("commercial", "Коммерция"), ("land", "Земля"), ("garage", "Гараж")], max_length=20, null=True, verbose_name="Тип объекта")),
                ("operation", models.CharField(blank=True, choices=[("sale", "Продажа"), ("rent_long", "Аренда"), ("rent_daily", "Посуточно")], max_length=20, null=True, verbose_name="Тип сделки")),
                ("subtype", models.CharField(blank=True, max_length=30, null=True, verbose_name="Подтип")),
                ...
                ("phone_country", models.CharField(blank=True, default="7", max_length=8, verbose_name="Код страны")),
                ...
                ("flat_type", models.CharField(blank=True, choices=[("apartment", "Квартира"), ("studio", "Студия"), ("apartments", "Апартаменты"), ("penthouse", "Пентхаус")], max_length=20, null=True, verbose_name="Подтип квартиры")),
                ...
                ("room_type_ext", models.CharField(blank=True, choices=[("room", "Комната"), ("share", "Доля комнаты/комната в квартире")], max_length=30, null=True, verbose_name="Подтип комнаты")),
                ...
                ("total_area", models.DecimalField(blank=True, decimal_places=2, max_digits=8, null=True, verbose_name="Общая площадь, м²")),
                ("living_area", models.DecimalField(blank=True, decimal_places=2, max_digits=8, null=True, verbose_name="Жилая площадь, м²")),
                ("kitchen_area", models.DecimalField(blank=True, decimal_places=2, max_digits=8, null=True, verbose_name="Площадь кухни, м²")),
                ...
                ("house_type", models.CharField(blank=True, choices=[("house", "Жилой дом"), ("dacha", "Дача"), ("townhouse", "Таунхаус"), ("cottage", "Коттедж")], max_length=20, null=True, verbose_name="Подтип дома")),
                ("heating_type", models.CharField(blank=True, choices=[("central", "Центральное"), ("gas", "Газовое"), ("electric", "Электро"), ("solid", "Твёрдое топливо")], max_length=20, verbose_name="Отопление")),
                ("land_area", models.DecimalField(blank=True, decimal_places=2, max_digits=8, null=True, verbose_name="Площадь участка")),
                ("land_area_unit", models.CharField(blank=True, choices=[("sotka", "Сотка"), ("sqm", "м²")], max_length=10, verbose_name="Единица участка")),
                ...
                ("land_type", models.CharField(blank=True, choices=[("izh", "ИЖС"), ("agriculture", "С/Х"), ("garden", "СНТ/садовый участок")], max_length=20, null=True, verbose_name="Подтип земельного участка")),
                ...
                ("commercial_type", models.CharField(blank=True, choices=[("office", "Офис"), ("retail", "Торговая"), ("warehouse", "Склад"), ("production", "Производство"), ("free_purpose", "Свободное назначение")], max_length=20, null=True, verbose_name="Подтип коммерции")),
                ...
                ("power", models.PositiveIntegerField(blank=True, help_text="Для коммерческих объектов ЦИАН", null=True, verbose_name="Выделенная мощность, кВт")),
                ("parking_places", models.PositiveIntegerField(blank=True, help_text="Количество мест для коммерческих объявлений", null=True, verbose_name="Паркомест")),
                ("has_parking", models.BooleanField(default=False, verbose_name="Есть парковка")),
                ("furnishing_details", models.CharField(blank=True, max_length=255, verbose_name="Комплектация (опис.)")),
                ...
                ("has_refrigerator", models.BooleanField(default=False, verbose_name="Холодильник")),
                ("has_dishwasher", models.BooleanField(default=False, verbose_name="Посудомойка")),
                ...
                ("has_ramp", models.BooleanField(default=False, help_text="Наличие пандуса для коммерческого объекта", verbose_name="Пандус")),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("prop", models.ForeignKey(on_delete=models.CASCADE, related_name="photos", to="core.property")),
            ],
